...
<body>
    <!--Start Header-->
    <table id="header" border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFC0CB">
        <tr>
            <td>
        ...
        <tr>
            <td>
                <table border="0" width="85%" cellpadding="15" cellspacing="0" align="center">
                    ...
                    <tr>
                        <td width="40%">
                            <img src="images/Me1.jpg" alt="Kritarth Ranjan"  width="90%">
                        </td>
                        <td width="60%">
            ...
            <td>
                <table border="0" width="85%" cellpadding="15" cellspacing="0" align="center">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <img src="images/Me2.jpg" alt="Achievements"  width="90%">
                        </td>
    ...
    <!--End Footer-->
    <script>
        alert("My name is kritarth ranjan");
    </script>
</body>
